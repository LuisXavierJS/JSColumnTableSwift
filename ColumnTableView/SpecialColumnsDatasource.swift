...
class SpecialColumnsDatasource: JSGenericColumnsTableController<SpecialColumnsTableViewCell> {
    ...
    override init(columnsTableView: ColumnsTableView) {
        super.init(columnsTableView: columnsTableView)
        self.items = colors
